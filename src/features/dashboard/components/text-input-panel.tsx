...
import { COST_PER_UNIT, TEXT_MAX_LENGTH } from "@/features/text-to-speech/data/constant";
...
export function TextInputPanel() {
  ...
  return (
    <div className="
      rounded-[22px] bg-linear-185 from-[#FDF2F8] from-15% via-[#FDF2F8] via-39% to-[#FEF3C7] to-85% p-0.5 shadow-[0_0_0_4px_white]
    ">
